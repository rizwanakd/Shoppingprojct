        ...
        <div class="row">
          <div class="span12">                          
            <div class="row">
              <div class="span12">
                <h4 class="title">
                  <span class="pull-left"><span class="text"><span class="line"> <strong><a href="<?php echo base_url(); ?>user_cont/view_product">Searched Item</strong></a></span></span></span>
                        ...
                        <li class="span3">
                          <div class="product-box">
                            ...
                            <p>
                              ...
                              <a href="<?php echo base_url(); ?>user_cont/view_product">
                               <?php echo '<img src="'.base_url().'uploads/'.$row->img. '" />'; ?> </a>
